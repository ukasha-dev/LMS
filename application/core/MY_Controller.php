    ...
    public function __construct()
    {
        ...
        if ($this->session->userdata('admin_tenant_id')) {
            ...
            $allowedTenantRoutes = [
                ...
                'designation' => ['tenantdesignationlist', 'tenantdesignationcreate', 'tenantdesignationedit', 'tenantdesignationdelete'],
                'leavetypes' => ['tenantleavetypeslist', 'tenantleavetypescreate', 'tenantleavetypesedit', 'tenantleavetypesdelete'],
                'subject' => ['tenantsubjectlist', 'tenantsubjectcreate', 'tenantsubjectedit', 'tenantsubjectdelete'],
                ...
                'feetype' => ['tenantfeetypelist', 'tenantfeetypecreate', 'tenantfeetypeedit', 'tenantfeetypedelete'],
                ...
                'staffidcard' => ['tenantstaffidcardcreate', 'tenantstaffidcardedit', 'tenantstaffidcarddelete'],
                'studentidcard' => ['tenantstudentidcardcreate', 'tenantstudentidcardedit', 'tenantstudentidcarddelete'],
                'item' => ['tenantitemcreate', 'tenantitemedit', 'tenantitemdelete'],
                ...
                'calendar' => ['tenanteventcreate', 'tenanteventedit', 'tenanteventdelete'],
                ...
                'syllabus' => ['tenantsyllabuscreate', 'tenantsyllabusedit', 'tenantsyllabusdelete'],
                'homework' => ['tenanthomeworkcreate', 'tenanthomeworkedit', 'tenanthomeworkdelete'],
                'alumni' => ['tenantalumnicreate', 'tenantalumniedit', 'tenantalumnidelete'],
                ...
                'menus' => ['tenantfrontmenucreate', 'tenantfrontmenuedit', 'tenantfrontmenudelete'],
            ];
