                            ...
                            <li class="treeview <?php echo activate_main_menu($side_list_value->activate_menu); ?>">
                                ...
                                <?php if (!empty($side_list_value->submenus)) { ?>
                                    <ul class="treeview-menu">
                                        ...
                                        } // End of dynamic submenus foreach

                                        // --- CUSTOM ADDITION: Campus Transfer inside Academics ---
                                        if ($side_list_value->lang_key == 'academics') { ?>
                                            <li class="<?php echo activate_submenu('admin/stdtransfer/campus_transfer_search', array('campus_transfer_search')); ?>">
                                                <a href="<?php echo base_url(); ?>admin/stdtransfer/campus_transfer_search">
                                                    <i class="fa fa-angle-double-right"></i> Campus Transfer
                                                </a>
                                            </li>
                                        <?php }
                                        if ($side_list_value->lang_key == 'human_resource') { ?>
                                            <li class="<?php echo activate_submenu('admin/staff/campus_transfer_search', array('campus_transfer_search')); ?>">
                                                <a href="<?php echo base_url(); ?>admin/staff/campus_transfer_search">
                                                    <i class="fa fa-angle-double-right"></i> Campus Transfer
                                                </a>
                                            </li>
                                        <?php } ?>
